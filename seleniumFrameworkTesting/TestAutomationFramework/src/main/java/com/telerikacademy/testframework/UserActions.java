...
public class UserActions {
    ...
    public void dragAndDropByXpath(String sourceXpathKey, String targetXpathKey) {
        int defaultTimeout = Integer.parseInt(getConfigPropertyByKey("config.defaultTimeoutSeconds"));
    ...
    public void waitForElementPresentWithText(String targetListXpath, String expectedCardName) {
    }
}
